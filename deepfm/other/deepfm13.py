...
CONFIG = {
    ...
    "features_list":  [
        "user_id","unique_id","gender_cd","residence_city_cd",
        "house_hold_type","marital_stattus_cd","edu_deg_cd","m_income","income_ind",
        "cust_ty","custtypes_01","yls_cust_type","xyl_tag","last_fq_dt",
        "last_fq_txk_amt","last_tx_dt","last_tx_amt","last_30d_login_app_days",
        "last_30d_push_touch_times","last_30d_sms_send_succ_cs","last_30d_tel_sCC_cs",
        "last_5d_coupon_cnt","last_10d_coupon_cnt","last_op_time","last_pboc_cx_dtуспсq03nwww.",
        "querycncq03wwlw","querycncebookswwflaged","сdaccapwwwww.","гvaccapwwwwww.",
        "гуграфиям","густармим","rvclaapwwww.","rvblsapwwwww.","rvnbmwww.","rvnbawpwwwww.",
        "rvapsappywww.","rvapmapwwwwww.","rvapaapwwwww.","repay_date_days","als_m1_id_bank_allnum",
        "als_m1_id_nbank_allnum","als_m3_id_bank_allnum","als_m3_id_nbank_allnum","br_modle_score",
        "query_times_bank_90d","query_imes_cfc_90d","risk_ms9_model_score","loss_model_group_v3",
        "yls_cust_typev2","latest_login_days","total_loan_cnt","total_loan_amt","last_1y_cps_num",
        "cuir_mon_use_gold_cnt","late_1mon_use_gold_cnt","late_3mon_use_gold_इंडो","late_6mon_use_gold_cnt",
        "cur_mon_use_points_cnt","late_1mon_use_points_cnt","late_3mon_use_points_cnt","late_6mon_use_points_cnt",
        "cur_mon_poins_sign_cnt","late_imon_points_sign_cnt","late_3mon_points_sign_cnt","late_6mon_points_sign_cnt",
        "cur_mon_points_luck_gift_cnt","late_1Imon_points_luck_gift_cnt","late_3mon_points_luck_gift_cnt",
        "late_6mon_points_luck_gift_cnt","cur_mon_cps_order_types","late_imon_cps_order_types",
        "late_3mon_cps_order_types","late_6mon_cps_order_types","last_mon_game_accum_click_cnt",
        "last_mon_game_accum_expo_cnt","last_mon_read_accum_click_cnt","last_mon_read_accum_expo_cnt",
        "cur_yili_vipterms","cur_juhui_vip_terms","last_login_ayh_time","last_login_app_time",
        "last_uas_reject_time","last_30d_fq_cs","last_30d_tx_cs","last_30d_login_ayh_days",
        "last_5d_lin_e_cnt","last_Sd_gu_e_cnt","last_yunying_jj_new_rate","last_yunying_jj_beegin_time",
        "last_yunying_jj_end_time","last_90d_yunying_jj_cs","last_180d_yunying_jj_cs","partner_yx_contr_cnt",
        "ayht10_all_respond_score","call_ans_score_t10","member_types","xyl_model_107","kzr_types","elec_types",
        "sms_types","if_sms_yn","if_ele_yn","if_500up_yn","if_bj_10_yn","if_bj_30_yn","avail_bal_cash",
        "send_coupon_cnt_1mon","use_coupon_cnt_1mon","valid_coupon_cnt","coupon_use","clkk_wyyh_count",
        "clk_llydg_count","clk_yhq_sy_count","clk_hyzx_sy_count","clk_jryhq_count","zaidai_days",
        "zaidai_days/mob_3y as zaidai_rate","avg_lim_use_rate","pril_bal","crdt_lim_yx","lim_use_rate",
        "zaidai_ctrl_rate","is_login","list_call_times_d","list_ansr_times_d","list_ansr_dur_d","list_manu_call_times_d",
        "list_manu_ansr_times_d","list_manu_ansr_dur_d","list_ivr_call_times_d","list_ivr_ansr_timees_d",
        "list_ivr_ansr_dur_d","list_call_times","list_ansr_times","list_ansr_dur","cust_call_times",
        "cust_ansr_times","cust_ansr_dur","cust_call_times_mon","cust_ansr_times_mon","cust_ansr_dur_mon",
        "cust_manu_call_times","cust_manu_ansr_times","cust_manu_ansr_dur","cust_manu_call_times_mon",
        "cust_manu_ansr_times_mon","cust_manu_ansr_dur_mon","cust_ivr_call_times","cust_ivr_ansr_times",
        "cust_ivr_ansr_dur","otust_ivr_call_times_mon","cust_ivr_ansr_times_mon","cust_ivr_ansr_dur_mon",
        "age","last_30d_tel_succ_cs","loss_model_ggroup_v3","risk_ms11_1_model_score","standard_score_group_v6_1",
        "last_month_expire_coupon_cnt","number_of_gold_be_used","last_10d_lin_e_cnt","last_10d_gu_e_cnt",
        "call_anss_score_t10","avail_cash","avg_limuse_rate","yls_cust_type_v2","cust_types_01","cust_types_02","igender_cd","icust_ty","label"
    ],
